...
class PlatformGroupController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('platform-groups.index', compact('platformGroups'));
    }

    // Mostrar el formulario para crear un nuevo grupo
    public function create()
    {
        return view('platform-groups.create');
    }
    ...
    public function store(StorePlatformGroupRequest $request)
    {
        ...
        return redirect()->route('platform-groups.index')->with('success', 'Platform group created successfully.');
    }
    ...
    {
        $platformGroup = PlatformGroup::findOrFail($id);
        return view('platform-groups.edit', compact('platformGroup'));
    }
    ...
    public function update(UpdatePlatformGroupRequest $request, $id)
    {
        ...
        return redirect()->route('platform-groups.index')->with('success', 'Platform group updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('platform-groups.index')->with('success', 'Platform group deleted successfully.');
    }
}
