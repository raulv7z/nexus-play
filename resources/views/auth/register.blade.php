<x-layouts.guest>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-presets.text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
        ...
        <div class="mt-4">
            ...
            <x-presets.text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-presets.text-input id="password" class="block mt-1 w-full"
                            type="password"
                            name="password"
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-presets.primary-button class="ms-4">
                {{ __('Register') }}
