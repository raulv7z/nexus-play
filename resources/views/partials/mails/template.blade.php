                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans
-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align
">
                                                        <br>{{__("Greetings,")}}<br>
                                                        NexusPlay</p>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    <p
                                                        ...
                                                        © 2024 NexusPlay. Todos los derechos reservados.</p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
